    ...
    >
      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-8 py-6 sm:py-8 md:pt-14 md:pb-20 lg:pt-16 lg:pb-24 grid grid-cols-1 md:grid-cols-[minmax(0,1fr)_minmax(320px,0.86fr)] gap-7 md:gap-12 lg:gap-16 items-center">
        ...
        <div className="flex flex-col gap-4 md:gap-5 lg:gap-6 order-1 md:order-1">
          ...
          <h1 className="font-serif text-[2.18rem] sm:text-[2.75rem] md:text-5xl lg:text-6xl font-semibold text-ink leading-[1.04] max-w-[13ch]">
            Um espaco seguro para cuidar da sua{" "}
            <em className="not-italic text-gradient-accent">saude emocional</em>
          </h1>

          <p className="font-sans text-sm sm:text-base lg:text-lg text-muted leading-relaxed max-w-lg">
          ...
          <div className="grid grid-cols-3 gap-3 rounded-lg border border-sand/80 bg-white/55 p-3 md:p-4">
      ...
      >
        <span className="font-sans text-[0.6rem] tracking-widest uppercase">
          Explorar
        </span>
